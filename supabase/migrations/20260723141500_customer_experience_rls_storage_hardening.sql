-- DAY NIGHT customer-experience final RLS and storage hardening.

begin;

-- Raw feedback contains audit metadata and IP hashes. Only administration reads the table directly.
...
create policy ce_feedback_admin_only_read on public.order_feedback for select to authenticated
