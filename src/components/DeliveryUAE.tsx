    ...
    <div className="space-y-12 text-right">
      ...
      <section className="text-center max-w-2xl mx-auto space-y-4">
        ...
        <p className="text-white/60 text-sm">
          نغطي المدن والبلديات الرئيسية بـ 30 درهم فقط، وهناك خدمات مخصصة للمناطق البعيدة في العين والمنطقة الغربية بـ 50 درهم، لضمان أعلى مستويات الالتزام والتغطية.
        </p>
      </section>
      ...
      <section className="space-y-6">
        <h3 className="text-xl font-bold text-white flex items-center gap-2 border-b border-white/10 pb-3 justify-end">
          <span>المدن والمناطق الرئيسية (السعر الموحد: 30 درهم)</span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {mainCities.map((city, idx) => (
            <div id={`main_city_${idx}`} key={idx} className="bg-brand-cool/30 p-5 rounded-xl border border-white/10 flex flex-col justify-between hover:border-brand-gold/50 hover:shadow-lg transition-all">
              ...
              <p className="text-brand-gold font-extrabold text-sm mt-3 pt-3 border-t border-white/5">30 AED</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-brand-cool/40 p-6 sm:p-10 rounded-3xl border border-white/10 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="space-y-1 text-right">
            <h3 className="text-lg font-bold text-white">المناطق البعيدة وتوصيلات الطواقم الخاصة (50 درهم)</h3>
