  ...
  const faqList: FAQItem[] = [
    {
      ...
      answer: "تبدأ التعرفة الموحدة التنافسية لجميع المدن والمناطق الرئيسية من 30 درهم إماراتي فقط للطرود متوسطة الحجم والمستندات بوزن عادي."
    },
    {
    ...
    },
    {
      ...
      answer: "تبدأ رسوم التوصيل للمناطق البعيدة وبلديات العين الخارجية ومناطق الظفرة والغربية (مثل الظهيرة والسلع وغياثي وحميم ليوا) من 50 درهم إماراتي نظراً لقيمة التنقل والفرز اللوجستي الخاص بها، فيما تبلغ تعرفة الرويس 30 درهم فقط كعرض خاص."
    },
    {
