              ...
              <div className="mt-3 text-sm">
                {(!from || !to) ? (
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-xs text-white/50 mt-2">{lang === 'ar' ? 'هذا تقدير قائم على فئة الأسعار الرسمية. السعر النهائي قد يختلف حسب حجم الشحنة ونوع الخدمة ووقت التسليم.' : 'This estimate is based on official pricing categories. Final price may vary based on package size, service type, and delivery timing.'}</div>
                  </div>
                ) : (
