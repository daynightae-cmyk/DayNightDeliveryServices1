...
export const aiAgentKnowledge = {
  ...
  prices: {
    domesticMain: "Main UAE cities: 30 AED final customer price",
    domesticMainAr: "المدن الرئيسية: 30 درهم السعر النهائي للعميل",
    domesticExtended: "Extended UAE areas: 50 AED final customer price",
    domesticExtendedAr: "المناطق الممتدة: 50 درهم السعر النهائي للعميل",
    alAin: "Al Ain: extended area — 50 AED final",
    westernRegion: "Western Region / Al Dhafra: extended — 50 AED final",
    alRuwais: "Al Ruwais (main area): 30 AED final",
    express: "Express surcharge: +15 AED",
    gcc: "GCC final prices start from 95 AED for the first kg; additional kg pricing is shown as a final quote by destination",
    gccExamples: "GCC 1kg=95 | 2kg=140 | 3kg=185 AED",
    worldwide: "Worldwide final prices start from 190 AED for the first kg; additional kg pricing is shown as a final quote by destination",
