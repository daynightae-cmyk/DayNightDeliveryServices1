...
const sourcePath = path.join(directory, "export-language-policy-gate-legacy.mjs");
const temporaryPath = path.join(directory, `.export-language-policy-gate-${process.pid}.mjs`);
const source = fs
