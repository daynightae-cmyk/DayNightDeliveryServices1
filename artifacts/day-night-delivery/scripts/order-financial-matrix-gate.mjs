...
if (typeof coverage.isExtendedCoverage !== "function") {
  ...
  assertEqual(coverage.isExtendedCoverage("Al Ruwais"), true, "Al Ruwais remains an extended 50 AED route");
  assertEqual(coverage.isExtendedCoverage("الرويس"), true, "Arabic Ruwais remains an extended 50 AED route");
...
expect(migration, /ruwais[\s\S]*return true/i, "database keeps Ruwais in extended pricing");
