  ...
  return (
    <details className="group fixed bottom-24 left-5 z-50">
      ...
      <div className="mt-3 w-72 rounded-2xl border border-white/10 bg-brand-deep p-3 shadow-2xl">
        ...
        <a href="#dn-admin-ai" className="block rounded-xl px-4 py-3 text-sm font-bold text-white hover:bg-white/10">Merchant Search</a>
        <a href="#dn-admin-core" className="block rounded-xl px-4 py-3 text-sm font-bold text-white hover:bg-white/10">Orders Workspace</a>
        <a href="#dn-admin-ai" className="block rounded-xl px-4 py-3 text-sm font-bold text-white hover:bg-white/10">Admin Alerts</a>
      </div>
    </details>
  );
}
