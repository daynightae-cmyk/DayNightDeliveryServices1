    ...
    return (
      <div className="dn-admin-home-full">
        <aside className="dn-admin-left-ai">
          ...
          <KhalifaGuidanceFeed key={active} isArabic={isArabic} orders={orders} merchants={merchants} financeSummary={financeSummary} sectionTitle={activeTitle} />
        </aside>
    ...
    <div className="dn-admin-fullscreen" dir={isArabic ? "rtl" : "ltr"}>
      ...
      <div className="dn-admin-layout-full">
        <main className="dn-admin-content-full">
          ...
          {active !== "dashboard" && <div className="mb-4"><KhalifaGuidanceFeed key={active} isArabic={isArabic} orders={orders} merchants={merchants} financeSummary={financeSummary} sectionTitle={activeTitle} /></div>}
          {renderContent()}
        </main>
