...
export default function Pricing() {
  ...
  const intlPdf = () => exportIntlQuotePDF({ destination: dest ? (isArabic ? dest.countryNameAr : dest.countryNameEn) : internationalDestination, weight: internationalWeight, firstKgPrice: dest ? dest.firstKg : 0, additionalKgPrice: dest ? dest.additionalKg : 0, total: international.total, zone: international.pricingCategory });
