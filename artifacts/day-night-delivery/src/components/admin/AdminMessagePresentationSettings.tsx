...
export default function AdminMessagePresentationSettings({ isArabic }: { isArabic: boolean }) {
  ...
  return (
    <section className="overflow-hidden rounded-[28px] border border-[#0057B8]/15 bg-white shadow-[0_20px_60px_rgba(7,26,51,0.10)]" dir={isArabic ? "rtl" : "ltr"}>
      <button
        type="button"
      ...
      >
        ...
        <span className="min-w-0 flex-1">
          ...
          <strong className="mt-1 block text-base font-black sm:text-lg">
            {isArabic ? "إعدادات تنسيق الرسائل" : "Message presentation settings"}
          </strong>
