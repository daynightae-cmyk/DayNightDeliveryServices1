...
const iconMap = {
  ...
  "address-issue": MapPinned,
  "missing-data": FileMinus,
  "merchant-confirmation": MessageCircleQuestion,
  "cash-collection": HandCoins,
  loading: Loader2,
  "quick-help": Sparkles,
  "shipment-details": PackageSearch,
  "daily-closing": CalendarClock,
  language: Languages,
  settings: Settings,
  notifications: Bell,
  search: Search,
