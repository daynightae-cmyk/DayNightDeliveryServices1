  ...
  return (
    <form data-admin-new-order-form="merchant" autoComplete="off" onSubmit={submit} className="rounded-[2rem] border border-brand-sky/20 bg-white/[0.045] p-5 shadow-2xl shadow-black/20" dir={isArabic ? "rtl" : "ltr"}>
      ...
      <section
        ...
        data-company-revenue={financials?.companyRevenue ?? ""} className="mt-4 rounded-[1.7rem] border border-brand-gold/30 bg-[linear-gradient(135deg,rgba(212,175,55,0.11),rgba(11,95,255,0.08),rgba(3,18,38,0.55))] p-4 sm:p-5">
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          <label className="space-y-2">
            ...
            <input type="number" min={0} step="0.01" data-admin-financial-input="true" data-admin-financial-field="goods_value" name="dn_goods_value_no_history_20260805" autoComplete="off" aria-autocomplete="none" inputMode="decimal" data-form-type="other" data-lpignore="true" data-1p-ignore="true" value={form.goods_value} onChange={(event) => setFinancialField("goods_value", event.currentTarget.value)} placeholder="100.00" className={inputClass()} required />
          ...
          <label className="space-y-2">
            ...
            <input type="number" min={0} step="0.01" inputMode="decimal" data-admin-financial-input="true" data-admin-financial-field="discount_amount" name="dn_discount_amount_no_history_20260805" autoComplete="off" aria-autocomplete="none" data-form-type="other" data-lpignore="true" data-1p-ignore="true" value={form.discount_amount ?? ""} onChange={(event) => setFinancialField("discount_amount", event.currentTarget.value)} placeholder={isArabic ? "اتركه فارغًا بدون خصم" : "Leave blank when there is no discount"} className={inputClass()} />
